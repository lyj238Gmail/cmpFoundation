...
axiomatization  where axiomOnf2 [simp,intro]:
   "s ∈ reachableSet (set (allInitSpecs N )) (rules N) \<Longrightarrow>  1 \<le> N \<Longrightarrow>i\<noteq>j \<Longrightarrow> 
...
axiomatization  where axiomOnf1 [simp,intro]:
   "s ∈ reachableSet (set (allInitSpecs N )) (rules N) \<Longrightarrow> i\<le>N \<Longrightarrow>formEval (f 0 ) s \<Longrightarrow> formEval (f i) s"
